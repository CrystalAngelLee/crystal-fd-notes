...
> [npm 源码](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm)
...
假设该脚本名为 .npm-init.js，我们执行命令`npm config set init-module ~\.npm-init.js` 来确保 npm init 所对应的脚本指向正确的文件
